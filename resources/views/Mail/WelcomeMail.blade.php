        ...
        <tr>
            <td align="center" style="padding: 50px 20px;">
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background: rgba(255,255,255,0.75); border: 1px solid rgba(255,255,255,0.5); border-radius: 36px; box-shadow: 0 25px 50px -18px rgba(0,0,0,0.15), 0 0 0 1px rgba(255,255,255,0.7) inset; overflow: hidden;">
                    ...
                    {{-- ── Header ── --}}
                    <tr>
                        <td style="background: linear-gradient(145deg, #4ECDC4, #2db8ae); padding: 40px 48px 36px; text-align: center; border-radius: 36px 36px 0 0;">
                            ...
                            <div style="display: inline-block; background: rgba(255,255,255,0.15); border: 1px solid rgba(255,255,255,0.3); border-radius: 80px; padding: 6px 20px; margin-bottom: 20px;">
                                <span style="color: rgba(255,255,255,0.9); font-size: 0.8rem; font-weight: 500; letter-spacing: 0.08em; text-transform: uppercase;">Employee Attendance System</span>
                            </div>
                    ...
                    <tr>
                        <td style="padding: 44px 48px;">
                            ...
                            {{-- Info Card --}}
                            <table width="100%" cellpadding="0" cellspacing="0" style="background: rgba(78,205,196,0.06); border: 1px solid rgba(78,205,196,0.2); border-radius: 20px; margin-bottom: 20px;">
                                <tr>
                                    <td style="padding: 24px 28px;">
                                        <div style="margin-bottom: 8px;">
                                            <span style="width: 10px; height: 10px; background: #4ECDC4; border-radius: 50%; display: inline-block; margin-right: 10px;"></span>
                                            <span style="font-size: 0.78rem; color: #7b8395; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em;">Account Status</span>
                                        </div>
                                        <p style="margin: 0; font-family: 'Space Grotesk', Arial, sans-serif; font-size: 1.5rem; font-weight: 700; color: #4ECDC4;">
                                            Active ✓
                                        </p>
                                    </td>
                                </tr>
                            ...
                            {{-- Features List --}}
                            <table width="100%" cellpadding="0" cellspacing="0" style="background: rgba(253,203,110,0.08); border: 1px solid rgba(253,203,110,0.25); border-radius: 20px; margin-bottom: 36px;">
                                <tr>
                                    <td style="padding: 24px 28px;">
                                        <p style="margin: 0 0 14px; font-size: 0.78rem; color: #7b8395; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em;">
                                            🚀 &nbsp;What you can do
                                        </p>
                                        <p style="margin: 0 0 10px; font-size: 0.95rem; color: #1b1f2c; line-height: 1.6;">
                                        ...
                                        <p style="margin: 0; font-size: 0.95rem; color: #1b1f2c; line-height: 1.6;">
                                            👤 &nbsp;Manage your profile
                                        </p>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <a href="{{ url('/') }}" style="display: inline-block; background: linear-gradient(145deg, #4ECDC4, #2db8ae); color: #ffffff; text-decoration: none; border-radius: 50px; padding: 1rem 2.8rem; font-size: 1rem; font-weight: 600; letter-spacing: 0.02em; box-shadow: 0 20px 30px -10px rgba(78,205,196,0.5);">
                                            Get Started
                                        </a>
                                    </td>
                                </tr>
