...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .success-msg::before { content: '✓'; font-size: 0.85rem; font-weight: 700; }
    </style>
</head>
...
<body class="">
    ...
    <div class="login-card glow-pulse" id="loginCard">
        <div class="card-inner">
            ...
            <div class="brand">
                ...
                <div class="brand-tagline">You will receive email for the new password</div>
            </div>
            ...
            <form action="{{ route('resetPassword') }}" method="post">
                ...
                @if (session('status') === false)
                    <div class="error-item" id="sessionErrorMsg">
                        {{ session('message') }}
                    </div>
                @endif
    ...
    <script>
        ...
        if (successMsg) {
            toastr.success(successMsg.textContent.trim());
        }

        /* ── SHOW SESSION ERROR AS TOAST ── */
        const sessionErrorMsg = document.getElementById('sessionErrorMsg');
        if (sessionErrorMsg) {
            toastr.error(sessionErrorMsg.textContent.trim());
        }
