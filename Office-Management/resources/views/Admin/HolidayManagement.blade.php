                    ...
                    <div class="glass-card" id="weekendFormCard">
                        <div class="form-inner">
                            <form id="WeekendHolidayForm">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn-add" id="add"><i class="fa-solid fa-plus" style="color:#fff;"></i> Add Weekend</button>
                    ...
                    <div class="glass-card" id="holidayFormCard">
                        <div class="form-inner">
                            <form id="HolidayForm">
                                ...
                                <div class="hint-text"><i class="fa-solid fa-triangle-exclamation" style="color:#FF4C60;"></i> Enter the exact same date range to remove a holiday.</div>
                            </form>
                        </div>
                    </div>
                </div>
